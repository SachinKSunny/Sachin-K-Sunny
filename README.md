...
Results-driven Software Engineering Manager with a strong expertise in microservice architecture, backend systems, application security and data engineering. Proven track record of leading engineering teams and architecting scalable, high-impact systems on GCP. Key accomplishments include architecting the Canada e-commerce platform modernization ($4M annual revenue), spearheading a cloud cost optimization initiative saving over $2.4M annually, and delivering a portfolio of projects generating millions in revenue (Item Substitutions $2.5M, Birthday Party Booking $2.1M).

My experiences, skill sets, and interests are listed below in no particular order:
- Data Engineering
- System Design
- Software Development
- Data Analytics & Interpretation
- Team Work, Collaboration, & Professional Communication
- Machine Learning
- Distributed Systems
- Product Design
- Negotiation
